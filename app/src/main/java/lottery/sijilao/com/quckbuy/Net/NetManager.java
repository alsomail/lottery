...
public enum NetManager {
    ...
    public NetManager getInstance(Context context) {
        if (mRequest == null)
    ...
    public void sendPostRequest(String url, Map map, NetCallBack callBack) {
        mRequest.postRequest(url, map, callBack);
    }


    public void sendGetRequest(String url, NetCallBack callBack) {
        mRequest.getRequest(url, callBack);
    }
